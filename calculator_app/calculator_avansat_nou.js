...
function deleteNumber(){
  ...
  console.log('deleteNumber ' + operationPressed + ' number=' + number);
...
digit1.addEventListener('click', function(){
  ...
  if(operationPressed==false) {
     ...
     console.log('EventListener ' + operationPressed + ' ' + number1);
  } else {
    number2=createNumber(number, 1);
    console.log('EventListener ' + operationPressed + ' ' + number2);
  }
